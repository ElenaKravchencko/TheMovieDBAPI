...
public class TmdbPeople extends AbstractTmdbApi {
    ...
    /**
     * This method is used to get the external ids for a person.
     * <p/>
     * It will return IMDB ID, Facebook, Freebase MID, Freebase ID, Instagram, TVRage ID, Twitter
     *
     * @param personId
     */
    public PersonExternalIds getPersonExternalIds(int personId) {
        ApiUrl apiUrl = new ApiUrl(TMDB_METHOD_PERSON, personId, "external_ids");

        return mapJsonResult(apiUrl, PersonExternalIds.class);
    }
